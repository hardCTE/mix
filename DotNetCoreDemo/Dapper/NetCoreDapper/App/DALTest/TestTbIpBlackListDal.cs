...
namespace App.DALTest
{
    public class TestTbIpBlackListDal
    {
        ...
        public void TestAddThenRemoveByIp()
        {
            ...
            var delCount = _dal.RemoveByIdxIp(items[0].Ip);
            Console.WriteLine($"delete 1, delCount={delCount}");
            ...
            var delCounts = _dal.RemoveByIdxIps((new[] {items[1].Ip, items[2].Ip, items[3].Ip}));
            Console.WriteLine($"delete 3, delCount={delCounts}");
        ...
        public void TestAddThenUpdate()
        {
            ...
            items[0].IsEnable = (sbyte) (items[0].IsEnable == 0 ? 1 : 0);
            ...
            items[1].IsEnable = (sbyte)(items[1].IsEnable == 0 ? 1 : 0);
            ...
            items[4].IsEnable = (sbyte)(items[4].IsEnable == 0 ? 1 : 0);
