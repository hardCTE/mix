    ...
    public static partial class SimpleCRUD
    {
        ...
        public class TableNameResolver : ITableNameResolver
        {
            public virtual string ResolveTableName(Type type)
            {
                ...
                //TODO: var tableattr = type.GetCustomAttributes(true).SingleOrDefault(attr => attr.GetType().Name == typeof(TableAttribute).Name) as dynamic;
                var tableattr = type.GetProperties().SingleOrDefault(attr => attr.GetType().Name == typeof(TableAttribute).Name) as dynamic;
                if (tableattr != null)
                {
...
internal static class TypeExtension
{
    ...
    public static bool IsSimpleType(this Type type)
    {
        ...
        //todo: return simpleTypes.Contains(type) || type.IsEnum;
